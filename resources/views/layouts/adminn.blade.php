...
<head>
    ...
    <!-- favicon
        ============================================ -->
    <link rel="shortcut icon" href="/assets/adminn/img/googlemap/1.png">
    <!-- Google Fonts
        ============================================ -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,700,700i,800" rel="stylesheet">
    <!-- Bootstrap CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/bootstrap.min.css">
    <!-- Bootstrap CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/font-awesome.min.css">
    <!-- adminpro icon CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/adminpro-custon-icon.css">
    <!-- meanmenu icon CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/meanmenu.min.css">
    <!-- mCustomScrollbar CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/jquery.mCustomScrollbar.min.css">
    <!-- animate CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/animate.css">
    <!-- data-table CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/data-table/bootstrap-table.css">
    <link rel="stylesheet" href="/assets/adminn/css/data-table/bootstrap-editable.css">
    <!-- normalize CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/normalize.css">
    <!-- charts C3 CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/c3.min.css">
    <!-- forms CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/form/all-type-forms.css">
    <!-- style CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/style.css">
    <!-- responsive CSS
        ============================================ -->
    <link rel="stylesheet" href="/assets/adminn/css/responsive.css">
    <!-- modernizr JS
        ============================================ -->
    <script src="/assets/adminn/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
...
<body class="materialdesign">
  ...
  <!--   <div class="chat-list-wrap">
    ...
    <!-- jquery
        ============================================ -->
    <script src="/assets/adminn/js/vendor/jquery-1.11.3.min.js"></script>
    <!-- bootstrap JS
        ============================================ -->
    <script src="/assets/adminn/js/bootstrap.min.js"></script>
    <!-- meanmenu JS
        ============================================ -->
    <script src="/assets/adminn/js/jquery.meanmenu.js"></script>
    <!-- mCustomScrollbar JS
        ============================================ -->
    <script src="/assets/adminn/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <!-- sticky JS
        ============================================ -->
    <script src="/assets/adminn/js/jquery.sticky.js"></script>
    <!-- scrollUp JS
        ============================================ -->
    <script src="/assets/adminn/js/jquery.scrollUp.min.js"></script>
    <!-- counterup JS
        ============================================ -->
    <script src="/assets/adminn/js/counterup/jquery.counterup.min.js"></script>
    <script src="/assets/adminn/js/counterup/waypoints.min.js"></script>
    <script src="/assets/adminn/js/counterup/counterup-active.js"></script>
    <!-- peity JS
        ============================================ -->
    <script src="/assets/adminn/js/peity/jquery.peity.min.js"></script>
    <script src="/assets/adminn/js/peity/peity-active.js"></script>
    <!-- sparkline JS
        ============================================ -->
    <script src="/assets/adminn/js/sparkline/jquery.sparkline.min.js"></script>
    <script src="/assets/adminn/js/sparkline/sparkline-active.js"></script>
    <!-- flot JS
        ============================================ -->
    <script src="/assets/adminn/js/flot/jquery.flot.js"></script>
    <script src="/assets/adminn/js/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/assets/adminn/js/flot/jquery.flot.spline.js"></script>
    <script src="/assets/adminn/js/flot/jquery.flot.resize.js"></script>
    <script src="/assets/adminn/js/flot/jquery.flot.pie.js"></script>
    <script src="/assets/adminn/js/flot/Chart.min.js"></script>
    <script src="/assets/adminn/js/flot/flot-active.js"></script>
    <!-- map JS
        ============================================ -->
    <script src="/assets/adminn/js/map/raphael.min.js"></script>
    <script src="/assets/adminn/js/map/jquery.mapael.js"></script>
    <script src="/assets/adminn/js/map/france_departments.js"></script>
    <script src="/assets/adminn/js/map/world_countries.js"></script>
    <script src="/assets/adminn/js/map/usa_states.js"></script>
    <script src="/assets/adminn/js/map/map-active.js"></script>
    <!-- data table JS
        ============================================ -->
    <script src="/assets/adminn/js/data-table/bootstrap-table.js"></script>
    <script src="/assets/adminn/js/data-table/tableExport.js"></script>
    <script src="/assets/adminn/js/data-table/data-table-active.js"></script>
    <script src="/assets/adminn/js/data-table/bootstrap-table-editable.js"></script>
    <script src="/assets/adminn/js/data-table/bootstrap-editable.js"></script>
    <script src="/assets/adminn/js/data-table/bootstrap-table-resizable.js"></script>
    <script src="/assets/adminn/js/data-table/colResizable-1.5.source.js"></script>
    <script src="/assets/adminn/js/data-table/bootstrap-table-export.js"></script>
    <!-- main JS -->
    <script src="/assets/adminn/js/main.js"></script>
