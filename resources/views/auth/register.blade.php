              ...
              <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                 ...
                 <div class="form-group{{ $errors->has('kelas') ? ' has-error' : '' }}">
                  <div class="input-group">
                    <input id="kelas" type="number" class="form-control" name="kelas" value="{{ old('kelas') }}" placeholder="Kelas" required autofocus>
                ...
                <div class="form-group{{ $errors->has('angkatan') ? ' has-error' : '' }}">
                  <div class="input-group">
                   <input id="angkatan" type="number" class="form-control" name="angkatan" value="{{ old('angkatan') }}" placeholder="angkatan"  required>
