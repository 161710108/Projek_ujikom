<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
 <!--      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center" style="width: 2030px;     height: 60px;">
        <ul class="navbar-nav navbar-nav-right">
         ...
         <!--        </div>
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="/img/female.png" alt="image" class="profile-pic">
                </div>
                <div class="preview-item-content flex-grow">
      ...
      <!--     <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <img class="img-xs rounded-circle" src="/img/female1.png" alt="Profile image">
            </a>
            ...
            <!--   <a class="dropdown-item">
              ...
              <a class="dropdown-item" href="/assets/admin/pages/samples/login.html" onclick="event.preventDefault();
